...
class dbconf_fcc{
	...
	public function __connect_db_fcc($h,$u,$p,$d)
	{
		...
		}elseif(function_exists('mysqli_connect'))
		{
			...
			$db = "[".date('d m Y - H:i:s')."] Can't Connect ! function connect to db not exists ! Contact ADMINISTRATOR \n";
	...
	public function __query_db_fcc($k,$q)
	{
		...
		}elseif(function_exists('mysqli_query'))
		{
			...
			$q = "[".date('d m Y - H:i:s')."] Query can't Executed !  Contact ADMINISTRATOR \n ";
